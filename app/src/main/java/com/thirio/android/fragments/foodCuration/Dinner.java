...
import static com.thirio.android.network.URLs.DINNER_BREADS;
import static com.thirio.android.network.URLs.DINNER_MAINCOURSE;
import static com.thirio.android.network.URLs.DINNER_SALADS;
import static com.thirio.android.network.URLs.DINNER_SIDES;


/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link Dinner.OnFragmentInteractionListener} interface
...
public class Dinner extends Fragment{
    ...
    private Dinner.OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        maincourse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("foodURL",DINNER_MAINCOURSE);
        ...
        sides.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(getContext(), Foods.class);
                intent.putExtra("foodURL",DINNER_SIDES);
        ...
        salads.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(getContext(), Foods.class);
                intent.putExtra("foodURL",DINNER_SALADS);
        ...
        breads.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(getContext(), Foods.class);
                intent.putExtra("foodURL",DINNER_BREADS);
        ...
        proceed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                Log.d("PROCEED",maincourse.getVisibility()+"");
                if(maincourseImg.getVisibility()==View.GONE){
                    ...
                    dbMethods.insertOrderNotPaid(id, itemNameMainCourse, itemNameSalad, itemNameSides, itemNameBreads, 4);
