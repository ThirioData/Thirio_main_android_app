...
import static com.thirio.android.network.URLs.BREAKFAST_BREADS;
import static com.thirio.android.network.URLs.BREAKFAST_MAINCOURSE;
import static com.thirio.android.network.URLs.BREAKFAST_SALADS;
import static com.thirio.android.network.URLs.BREAKFAST_SIDES;


/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link Breakfast.OnFragmentInteractionListener} interface
...
public class Breakfast extends Fragment{
    ...
    private Breakfast.OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        maincourse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("foodURL",BREAKFAST_MAINCOURSE);
        ...
        sides.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(getContext(), Foods.class);
                intent.putExtra("foodURL",BREAKFAST_SIDES);
        ...
        salads.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(getContext(), Foods.class);
                intent.putExtra("foodURL",BREAKFAST_SALADS);
        ...
        breads.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(getContext(), Foods.class);
                intent.putExtra("foodURL",BREAKFAST_BREADS);
        ...
        proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(maincourseImg.getVisibility()==View.GONE){
                    ...
                    dbMethods.insertOrderNotPaid(id, itemNameMainCourse, itemNameSalad, itemNameSides, itemNameBreads, 1);
